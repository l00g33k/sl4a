...
case "$siteprefix" in
'') if test "/sdcard/com.googlecode.perlforandroid/extras/perl" = "/data/data/com.googlecode.perlforandroid/files/perl"; then
	siteprefix="$prefix"
    else
...
'') if test "" = "/data/data/com.googlecode.perlforandroid/files/perl"; then
	vendorprefix="$prefix"
    else
	vendorprefix=''
    fi
...
'') if test "/data/data/com.googlecode.perlforandroid/files/perl" = "/data/data/com.googlecode.perlforandroid/files/perl"; then
...
#     /data/data/com.googlecode.perlforandroid/files/perl, so it isn't included here either.
#
