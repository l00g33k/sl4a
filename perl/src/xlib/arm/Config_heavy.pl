...
ccflags_nolargefiles='-DANDROID -fno-strict-aliasing '
ldflags_nolargefiles=''
libs_nolargefiles='-ldl -lm -lc'
libswanted_nolargefiles='sfio socket bind inet nsl nm ndbm gdbm dbm db malloc dl dld ld sun m crypt sec util c cposix posix ucb BSD'
EOVIRTUAL
eval {
